                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php foreach ($data as $data) {
                            ...
                            ?>
                                <img src="<?= base_url('assets/datakoperasi/imganggota/ktp/') ?><?= $data['foto_ktp_anggota'] ?>" class="img-fluid" alt="Responsive image" width="250px">
                            <?php
                            }
                            ?>
                            <br>
                            ...
                            ?>
                                <img src="<?= base_url('assets/datakoperasi/imganggota/kyc/') ?><?= $data['foto_selfie_ktp_anggota'] ?>" class="img-fluid" alt="Responsive image" width="250px">
                            <?php
                            }
                            ?>
                        <?php } ?>
